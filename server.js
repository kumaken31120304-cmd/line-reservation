...
app.post('/api/reserve', async (req, res) => {
  ...
  const { userId, name, phone, date, time, course, symptoms, medicalHistory } = req.body || {};
  ...
  try {
    ...
    const reservation = await createReservation({ userId, name, phone, date, time, course, symptoms, medicalHistory });
